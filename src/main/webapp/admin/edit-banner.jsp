            ...
            <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="email" class="form-control" id="exampleInputEmail1" value="Banner trang chủ">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">link banner</label>
                  <input type="email" class="form-control" id="exampleInputEmail1" value="https://bachkhoa-aptech.edu.vn/bachkhoa-aptech-thong-bao-xet-tuyen-dot-3-tuyen-sinh-50-chi-tieu-den-het-20-09-2018/529.html">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <img src="https://bachkhoa-aptech.edu.vn/upload/image/banner-web(1).jpg" alt="" width="250px">
                </div>
                <div class="form-group">
